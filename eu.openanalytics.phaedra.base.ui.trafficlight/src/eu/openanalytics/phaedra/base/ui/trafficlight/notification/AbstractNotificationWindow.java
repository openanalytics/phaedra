...
public abstract class AbstractNotificationWindow extends Window {
		...
		protected IStatus run(IProgressMonitor monitor) {
			if (!display.isDisposed()) {
				display.asyncExec(new Runnable() {
					public void run() {
						Shell shell = AbstractNotificationWindow.this.getShell();
						...
						AbstractNotificationWindow.this.closeFade();
					}
				});
			}
	...
	public AbstractNotificationWindow(Display display) {
		this(display, SWT.NO_TRIM | SWT.ON_TOP | SWT.NO_FOCUS | SWT.TOOL);
	}

	public AbstractNotificationWindow(Display display, int style) {
	...
	protected String getPopupShellTitle() {
		...
		if (product != null) {
			...
			return productName + " Notification";
		} else {
			return "Notification";
		}
	}
	...
	protected void createTitleArea(Composite parent) {
		...
		button.setImage(IconManager.getIconImage("notification-close.gif"));
		button.addMouseTrackListener(new MouseTrackAdapter() {
			@Override
			public void mouseEnter(MouseEvent e) {
				button.setImage(IconManager.getIconImage("notification-close-active.gif"));
			}
			@Override
...
//				gc.fillGradientRectangle(clArea.x, clArea.y, clArea.width, clArea.height, true);
		...
		middleContentCircle.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_BLACK));
