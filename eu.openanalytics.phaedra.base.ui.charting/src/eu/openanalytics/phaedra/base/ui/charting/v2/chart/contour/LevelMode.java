...
public abstract class LevelMode {
    ...
    public static LevelMode LINEAR = new LevelMode( "linear" ) {
        public double[] calculateLevels( double[] array, int nLevel,
     ...
     *                    much sense
     */
    public abstract double[] calculateLevels( double[] array, int nLevel,
                                              double offset, boolean isCounts );
     ...
     * @return  level array
     */
    private static double[] calculateLinearLevels( double[] array,
     ...
     * @return  level array
     */
    private static double[] calculateLogLevels( double[] array,
                                                int nLevel, double offset,
                                                boolean isCounts ) {
     ...
     * @return  level array
     */
    private static double[] calculateEquivLevels( double[] array,
                                                  int nLevel, double offset,
                                                  boolean isCounts ) {

        /* Sort the pixel values. */
        int npix = array.length;
     ...
     */
    private static double[] getCutLimits( double[] array, int nExclude,
                                          boolean isLog ) {
