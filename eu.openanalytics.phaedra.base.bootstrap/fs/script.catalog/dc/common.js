...
/**
 * Perform a callback function at the end of the capture job (regardless of outcome).
 * Use this to clean up resources generated by the module.
 */
function postCapture(callback) {
	setParameter(ctx.getActiveModule().getId() + ".postCapture", callback);
}
