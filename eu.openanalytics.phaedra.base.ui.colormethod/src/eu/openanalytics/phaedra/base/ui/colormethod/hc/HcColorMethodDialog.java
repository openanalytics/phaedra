...
public class HcColorMethodDialog extends BaseColorMethodDialog {
	...
	private HcColorMethod colorMethod;
	
	public HcColorMethodDialog(Shell parentShell, IColorMethod cm) {
		super(parentShell, cm);
		
		colorMethod = (HcColorMethod)getColorMethod();
		originalRGBs = new RGB[3];
		originalRGBs[0] = colorMethod.getMinRGB();
		originalRGBs[1] = colorMethod.getHcRGB();
	...
	private void updatePreview() {
		...
		colorMethod.setHcRGB(colorSelectors[1].getColorValue());
	...
	protected void doCancel() {
		...
		colorMethod.setHcRGB(originalRGBs[1]);
