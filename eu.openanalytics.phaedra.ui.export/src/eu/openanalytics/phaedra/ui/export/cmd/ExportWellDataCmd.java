...
import eu.openanalytics.phaedra.ui.export.wizard.well.ExportWellsWizard;

public class ExportWellDataCmd extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!experiments.isEmpty()) {
			WizardDialog dialog = new WizardDialog(window.getShell(),
					new ExportWellsWizard(experiments));
			dialog.open();
		}
		return null;
	}
