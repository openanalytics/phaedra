...
public class SelectSubWellDataPage extends BaseStatefulWizardPage {
	...
	public void createControl(Composite parent) {
    	...
    	setDescription("Select a file containing subwell data (optional).");
    	setControl(area);
	...
	private void analyzeSelectedFile() {
		...
		wizardState.parameters.put("subwelldata.file", file.getAbsolutePath());
		SimpleProtocolAnalyzer.analyzeFile(wizardState, file.getAbsolutePath(), SimpleProtocolAnalyzer.SCRIPT_ANALYZE_SUBWELLDATA, getContainer());
	}
}
