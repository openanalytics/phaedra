...
public class SelectImageDataPage extends BaseStatefulWizardPage {
	...
	public void createControl(Composite parent) {
    	...
    	setDescription("Select an image file (optional).");
    	setControl(area);
	...
	private void analyzeSelectedFile() {
		...
		wizardState.parameters.put("imagedata.file", file.getAbsolutePath());
		SimpleProtocolAnalyzer.analyzeFile(wizardState, file.getAbsolutePath(), SimpleProtocolAnalyzer.SCRIPT_ANALYZE_IMAGEDATA, getContainer());
	}
}