...
public class WellDensity2DConfigDialog extends WellChartConfigDialog {
	...
	public WellDensity2DConfigDialog(Shell parentShell, WellDensity2DLayer layer) {
	...
	private void createSettingsTab(TabFolder tabFolder) {
		...
		btnSkipZeroDensity.addListener(SWT.Selection, e -> {
		...
		gaussianSpinner.addListener(SWT.MouseUp, e -> {
		...
		symbolSize.addListener(SWT.Selection, e -> {
