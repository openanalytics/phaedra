...
public abstract class WellChartConfigDialog extends TitleAreaDialog implements ILayerConfigDialog {

	public static final int AUXILARY_DIMENSION_COUNT = 3;

	private TabFolder tabFolder;
	private WellChartLayer layer;

	private String fillOption;
	private String prevFillOption;

	public WellChartConfigDialog(Shell parentShell, WellChartLayer layer) {
		super(parentShell);
		this.layer = layer;
	...
	protected void okPressed() {
		...
		GridState.saveValue(layer.getProtocolId(), layer.getId(), WellChartLayer.PROPERTY_CONFIG, getConfig());
		GridState.saveValue(layer.getProtocolId(), layer.getId(), WellChartLayer.FILL_OPTION, fillOption);
	...
	public WellChartLayer getLayer() {
		return layer;
	}

	public LayerSettings<Plate, Well> getConfig() {
