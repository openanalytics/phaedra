...
public class WellFeaturePage extends BaseStatefulWizardPage {

	private NewFeatureTableViewer tableViewer;
	
	protected WellFeaturePage() {
		super("Well Features");
	}
	...
	public void createControl(Composite parent) {
		...
		setTitle("Well Features");
    	setDescription("Select the Well Features that should be included in the Protocol.");
	...
	public void applyState(IWizardState state, boolean firstTime) {
		tableViewer.setInput(((WizardState)state).wellFeatures);
	}
}
