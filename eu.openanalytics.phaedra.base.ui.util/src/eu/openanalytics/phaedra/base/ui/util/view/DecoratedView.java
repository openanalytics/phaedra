...
/**
 * An instance of this class is a ViewPart that can be decorated with additional functionality.
 ...
 * </p>
 */
public abstract class DecoratedView extends ViewPart implements IDecoratedPart {

	private List<PartDecorator> decorators;
	private MenuManager contextMenu;

	public DecoratedView() {
		super();
