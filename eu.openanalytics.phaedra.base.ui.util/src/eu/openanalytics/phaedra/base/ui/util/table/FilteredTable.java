...
public class FilteredTable extends Composite {
	 ...
	 * @since 3.5
	 */
	public FilteredTable(Composite parent, int tableStyle, FilterMatcher filter, boolean useNewLook) {
	...
	protected WorkbenchJob doCreateRefreshJob() {
		return new WorkbenchJob("Refresh Filter") {//$NON-NLS-1$
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				Control redrawFalseControl = tableComposite != null ? tableComposite
							...
							e.result = NLS
									.bind(
											...
											new String[] {
													filterTextString,
													String
															.valueOf(getViewer().getTable().getItemCount()) });
						}
					}
				});
