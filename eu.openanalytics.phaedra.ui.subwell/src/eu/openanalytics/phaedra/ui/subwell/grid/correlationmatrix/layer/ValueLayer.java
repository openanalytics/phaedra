...
import eu.openanalytics.phaedra.ui.plate.grid.correlationmatrix.layer.ValueProvider;
...
public class ValueLayer extends FeatureWellLayer {
	...
	private class LabelRenderer extends BaseGridCellRenderer {
		...
		public String getTooltipContribution(GridCell cell) {
			...
			if (o == null) return "";
			List<SubWellFeature> features = (List<SubWellFeature>) o;
